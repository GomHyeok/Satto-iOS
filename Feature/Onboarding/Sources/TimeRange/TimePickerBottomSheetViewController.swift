...
class TimePickerBottomSheetViewController: UIViewController {
    ...
    private lazy var collectionView: UICollectionView = {
        ...
        collectionView.register(TimeRangeCell.self, forCellWithReuseIdentifier: TimeRangeCell.identifier)
    ...
    override func viewDidLoad() {
        ...
        if let defaultIndex = timeRanges.firstIndex(of: "23:00 ~ 00:59") {
            collectionView.selectItem(at: IndexPath(item: defaultIndex, section: 0), animated: false, scrollPosition: [])
...
extension TimePickerBottomSheetViewController: UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        guard let cell = collectionView.dequeueReusableCell(withReuseIdentifier: TimeRangeCell.identifier, for: indexPath) as? TimeRangeCell else {
...
extension TimePickerBottomSheetViewController: UICollectionViewDelegate {
    ...
    func collectionView(_ collectionView: UICollectionView, shouldDeselectItemAt indexPath: IndexPath) -> Bool {
        ...
        if collectionView.indexPathsForSelectedItems?.count == 1 && collectionView.indexPathsForSelectedItems?.first == indexPath {
            return false
        }
        return true
    }
